                    ...
                    <div class="row col-md-12 pr-0">
                        <div class="col-md-10 btn-group mb-3 pl-0" >
                            <form action="" method="GET" class="row col-md-10">
                                <input type="text" name="search" class="form-control col-md-4" placeholder="Search by name or email" value="@if(!empty($_REQUEST['search'])){{$_REQUEST['search']}}@endif" />

                                <button type="submit" class="btn btn-primary px-8 ml-2">
                                    <i class="material-icons">filter_alt</i>
                                    Apply Filter</button>
                                <a href="{{url('users')}}" class="btn btn-secondary ml-2">
                                    <i class="material-icons">filter_alt_off</i>
                                    Reset</a>
                            </form>
                        </div>
                        <div class="col-md-2 pr-0" >
                            <a href="{{url('users/create')}}" class="btn btn-primary float-right">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{url('/users/' .Hashids::encode($item->id))}}" accept-charset="UTF-8" style="display:inline">
